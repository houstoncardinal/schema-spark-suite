  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px -5px rgba(66,99,235,0.3)" },
          "50%": { boxShadow: "0 0 40px -5px rgba(66,99,235,0.5)" },
        },
        ...
        "blur-in": { "0%": { opacity: "0", filter: "blur(8px)" }, "100%": { opacity: "1", filter: "blur(0px)" } },
      },
      animation: {
